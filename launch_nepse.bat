...
if "%choice%"=="4" goto RUN_QUICKPICK
if "%choice%"=="5" goto RUN_SMARTPICK
...
:IPO_TRACKER
python nepse_scanner.py --ipo-tracker
pause
goto MENU
...
:RUN_QUICKPICK
python _marketcheck.py
if errorlevel 1 python nepse_scanner.py --quickpick --offline & goto AGAIN
